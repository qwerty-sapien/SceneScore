...
Greenfield local-first animation-to-jazz studio. Phase 1 provides executable contracts and a synthetic fixture harness; application implementation and media work have not started.
